import { auth, loginWithGoogle as loginWithGoogleCore, logout as logoutCore, setupRecaptcha as setupRecaptchaCore, loginWithPhone as loginWithPhoneCore, deleteCurrentUser } from '../lib/firebase';
